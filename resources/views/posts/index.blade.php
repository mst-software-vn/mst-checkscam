      ...
      <div class="mb-14 flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
        ...
        <div class="max-w-2xl">
          ...
          <p class="mt-4 text-base text-gray-500 md:text-lg dark:text-gray-400">
            Chia sẻ kinh nghiệm kiếm tiền online an toàn, thủ thuật bảo vệ tài sản và cập nhật các hành vi lừa đảo mới
            nhất.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3" id="posts-grid">
          @if ($featuredPost)
            ...
            <article class="group md:col-span-2 lg:col-span-3">
              <a
                href="{{ route('posts.frontend.show', $featuredPost->slug) }}"
              ...
              >
                ...
                <div class="lg:col-span-5">
                  ...
                  <p class="mt-4 line-clamp-3 text-base leading-relaxed text-gray-500 dark:text-slate-200">
            ...
            <div class="my-4 border-b border-gray-100 md:col-span-2 lg:col-span-3 dark:border-gray-800"></div>
          @endif

          @forelse ($posts as $post)
            <!-- Regular Post Item -->
            <article class="group flex h-full flex-col">
              <a href="{{ route('posts.frontend.show', $post->slug) }}" class="flex h-full flex-col overflow-hidden">
                ...
                <div class="flex flex-1 flex-col py-6">
                  ...
                  <p class="mt-3 line-clamp-2 text-sm leading-relaxed text-gray-500 dark:text-slate-200">
                    {{ $post->description }}
                  </p>
                  <div
        ...
        @if ($posts->hasMorePages())
          <div class="mt-20 flex justify-center" id="load-more-container">
            ...
            >
              ...
              <i class="fa-solid fa-arrow-down-long text-xs transition-transform group-hover:translate-y-1"></i>
            </button>
          </div>
        @endif
      </div>
