    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col gap-6 lg:flex-row">
              ...
              <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                  ...
                  <div class="text-left">
                    ...
                    <div class="flex items-center gap-2 text-[10px] font-bold tracking-tighter text-gray-400 uppercase">
              ...
              >
                @if (! empty($post->hashtags))
                  <div class="flex flex-wrap items-center gap-2">
                    <span class="mr-2 text-[10px] font-black tracking-[0.2em] text-gray-400 uppercase">Tags:</span>
                ...
                <div class="flex items-center gap-6">
                  ...
                  <p class="text-[10px] font-bold tracking-tight text-gray-400 uppercase">Đã chia sẻ bài viết này</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="mt-16">
            <div class="mb-8 flex items-center justify-between">
              <div class="flex items-center gap-3">
                ...
                <h2 class="text-xl font-black tracking-tight text-gray-900 uppercase dark:text-gray-300">
                  Cẩm nang liên quan
                </h2>
              </div>
              <a href="/bai-viet" class="text-cs_blue text-[11px] font-black tracking-widest uppercase hover:underline">
                Xem tất cả
              </a>
            </div>
        ...
        <aside class="sticky top-32 h-fit w-full space-y-4 lg:w-[350px]">
          ...
          <x-banner-ads position="blog" class="mb-4" />
          ...
          >
            <div class="border-b border-gray-50 bg-gray-50/50 p-6 dark:border-gray-800 dark:bg-slate-800/30">
              <h4
