        ...
        <div class="mb-16 grid grid-cols-1 gap-12 md:grid-cols-12">
            ...
            <div class="space-y-6 md:col-span-5">
                ...
                <div class="flex gap-4">
                    ...
                    <a
                        href="#"
                        class="hover:bg-cs_red hover:border-cs_red group flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 transition-all"
                    >
            ...
            <div class="space-y-6 md:col-span-2">
                <h4 class="border-cs_blue border-l-4 pl-3 text-xs font-black tracking-widest text-white uppercase">
                    Hệ Thống
                </h4>
                <ul class="space-y-3">
                    <li>
                        <a href="/" class="hover:text-cs_blue text-sm font-bold text-gray-400 transition-colors">
                            Kiểm tra Scam
                        </a>
                    </li>
                    <li>
                        <a
                            href="/bao-hiem-cs"
                            class="hover:text-cs_blue text-sm font-bold text-gray-400 transition-colors"
                        >
                            Quỹ bảo hiểm
                        </a>
                    </li>
            ...
            <!-- Links Column 2 -->
            <div class="space-y-6 md:col-span-2">
                <h4 class="border-cs_red border-l-4 pl-3 text-xs font-black tracking-widest text-white uppercase">
                    Trợ Giúp
                </h4>
                <ul class="space-y-3">
                    <li>
