...
@section('title', isset($insurance) ? 'Sửa Quỹ Bảo Hiểm' : 'Thêm Quỹ Bảo Hiểm')
@section('content')
  @include(
              ...
              <div class="col-lg-6 col-sm-6 col-12">
                <div class="form-group">
                  ...
                  <select name="status" class="select">
                    <option value="1" {{ old('status', $insurance->status ?? 1) == 1 ? 'selected' : '' }}>
                      Hoạt động
                    </option>
                    <option value="0" {{ old('status', $insurance->status ?? 1) == 0 ? 'selected' : '' }}>
                      Tạm dừng
                    </option>
                  </select>
                </div>
