    ...
    <div class="p-6 pt-10 sm:p-10 sm:pb-5">
      ...
      <div class="relative mb-6 flex flex-col items-center">
        ...
        <div class="relative mb-4">
          <div class="flex h-20 w-20 items-center justify-center rounded-3xl bg-red-50 shadow-inner dark:bg-red-900/50">
      ...
      <div class="space-y-5 text-center">
        <p class="text-sm leading-relaxed font-medium text-gray-700 sm:text-base dark:text-gray-300">
          {!! App\Helpers\ConfigHelper::getConfig('site_notification_text', 'Hiện nay có rất nhiều tài khoản FB, TK ngân hàng, website, group và bot giả mạo <span class="bg-cs_blue/10 text-cs_blue rounded px-1.5 font-bold uppercase italic">Admin/Gdv CS</span> nhằm lừa đảo người dùng.') !!}
        </p>
      </div>
    </div>
