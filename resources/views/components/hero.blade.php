...
<section class="relative overflow-hidden py-12 {{ $isAction ? 'md:pb-20' : '' }} md:pb-2">
  <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-4xl text-center">
      <h1 class="hero-title scanner-title mb-6 text-3xl leading-[1.4] font-black uppercase md:text-4xl lg:text-5xl">
      ...
      >
        Hệ thống dữ liệu lớn nhất Việt Nam giúp bạn kiểm tra độ tín nhiệm của đối tác thông qua SĐT, Số TK hoặc Link
        mạng xã hội.
      </p>
            ...
            if (data && data.length > 0) {
              $.each(data, function (index, item) {
                ...
                if (item.type === 'bank') {
                  ...
                  typeColor = 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400';
                  typeLabel = 'Facebook';
                }
                ...
                const $li = $('<li>', {
                  class:
                    'flex items-center gap-3 px-7 py-5 hover:bg-gray-50 dark:hover:bg-slate-800/60 cursor-pointer transition-colors group',
                  html: `
              ...
              const $ghostLi = $('<li>', {
                class:
                  'flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-slate-800/60 cursor-pointer transition-colors group',
                html: `
            <i class="fa-solid fa-magnifying-glass text-gray-300 dark:text-gray-600 text-xs group-hover:text-gray-400 transition-colors"></i>
