    ...
    <main class="bg-gray-50/40 dark:bg-dark_bg pb-24">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6 mb-12">
                ...
                >
                    <div
                        class="w-20 h-20 bg-cs_blue/10 text-cs_blue rounded-full flex items-center justify-center shrink-0"
                    >
                        <i class="fa-solid fa-scale-balanced text-3xl"></i>
                    </div>
                    <div class="space-y-3">
                        <h2 class="text-xl font-black text-gray-800 dark:text-white uppercase tracking-tight">
                            Quy trình công bằng
                        </h2>
                ...
                >
                    <div
                        class="w-20 h-20 bg-cs_red/10 text-cs_red rounded-full flex items-center justify-center shrink-0"
                    >
            ...
            >
                <h3
                    class="text-lg font-black uppercase text-gray-800 dark:text-white mb-6 border-l-4 border-cs_blue pl-4"
                >
                    Lưu ý quan trọng
                </h3>
                <div class="space-y-4">
