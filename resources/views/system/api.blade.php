        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                ...
                >
                    ...
                    <h2 class="text-xl font-black text-gray-800 dark:text-white uppercase mb-4">
                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-6">
                        ...
                        >
                            ...
                            <code
                                class="text-sm font-mono text-gray-300 block bg-black/30 p-3 rounded-lg border border-white/5"
                            >
