                        ...
                        <div class="divide-y divide-gray-50 dark:divide-gray-800/50">
                            ...
                            >
                                ...
                                <div class="ml-3 flex-1 md:ml-4">
                                    ...
                                    <h3
                                        class="text-sm font-bold text-emerald-600 uppercase md:text-lg dark:text-emerald-400"
                                    >
                            ...
                            >
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p
                                            class="line-clamp-2 text-[11px] leading-relaxed text-gray-500 italic md:text-xs"
                                        >
                                            "{{ $related->description }}"
                                        </p>
                                    </div>
                    ...
                    <div class="p-6">
                                ...
                                >
                                    ...
                                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                                        ...
                                        <div class="relative flex-1" id="name-input-wrapper">
                                            ...
                                            >
                                                <i
                                                    class="fa-solid fa-user text-[10px] text-gray-300 dark:text-gray-600"
                                                ></i>
                                            </div>
                                            <input
                                                type="text"
                                        ...
                                        >
                                            ...
                                            <div>
                                                <span
                                                    class="block text-[10px] font-bold text-gray-600 dark:text-gray-300"
                                                >
                                                    Ẩn danh
                                                </span>
                                ...
                                <div class="flex gap-3 md:gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-2.5 flex items-center justify-between">
                                            <span class="text-[10px] font-medium text-gray-400" id="char-count">
                                                0 / 1000
                                            </span>
                                            <div class="flex items-center gap-2">
                                                <span
                                                    class="hidden text-[10px] font-bold text-amber-500"
                                                    id="rate-limit-hint"
                                                >
                        ...
                        @if ($comments->count() > 0)
                            <div class="mb-6 flex items-center gap-3">
                                ...
                                <span class="text-[9px] font-bold tracking-[3px] text-gray-400 uppercase">
                                    Bình luận gần đây
                                </span>
                                <div class="h-px flex-1 bg-gray-100 dark:bg-gray-800"></div>
                            </div>
                        ...
                        <div class="space-y-5" id="comment-list">
                            @forelse ($comments as $comment)
                                ...
                                <div
                                    class="comment-item group flex gap-3 md:gap-4"
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        >
                                            ...
                                            <div class="mb-2.5 flex flex-wrap items-center justify-between gap-2">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <span
                                                        class="text-[9px] font-bold tracking-tighter text-gray-400 uppercase"
                                                    >
