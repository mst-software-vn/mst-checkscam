    ...
    <main class="grow pb-16 w-full max-w-6xl mx-auto px-4 sm:px-6 relative z-30 -mt-4 md:mt-0">
                    ...
                    >
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-1 block">
                        ...
                        <div class="flex items-center gap-2">
                            <span
                                class="text-[9px] font-black text-white bg-cs_red px-2 py-0.5 rounded uppercase tracking-tighter"
                            >
                                Bị tố cáo
                            </span>
                        </div>
                        ...
                        <div class="divide-y divide-gray-50 dark:divide-gray-800/50">
                            ...
                            >
                                ...
                                <div class="ml-3 md:ml-4 flex-1">
                                    ...
                                    <h3
                                        class="text-sm md:text-base font-bold text-gray-800 dark:text-gray-100 uppercase"
                                    >
                                        Phan Thi Thuy V.
                                    </h3>
                                </div>
                                <button class="text-gray-300 hover:text-cs_blue transition-colors px-2">
                            ...
                            >
                                ...
                                <div class="ml-3 md:ml-4 flex-1">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span
                                            class="bg-gray-100 dark:bg-slate-800 text-gray-400 text-[8px] font-black px-1 py-0.5 rounded border border-gray-200 dark:border-gray-700 uppercase"
                                        >
                                            Vietcombank
                                        </span>
                                    </div>
                                ...
                                <button
                                    class="bg-white dark:bg-slate-800 border border-gray-100 dark:border-gray-700 text-gray-400 hover:text-cs_blue transition-all w-7 h-7 rounded flex items-center justify-center shadow-sm active:scale-95"
                                >
                                    <i class="fa-regular fa-copy text-xs"></i>
                                </button>
                            </div>
                            ...
                            >
                                ...
                                <div class="ml-3 md:ml-4 flex-1">
                                    ...
                                    <div class="flex flex-wrap items-center gap-3 mt-1">
                                        ...
                                        <a href="#" class="text-sky-500 hover:scale-110 transition-transform">
                                            <i class="fa-brands fa-telegram text-base"></i>
                                        </a>
                                        <a href="#" class="text-pink-500 hover:scale-110 transition-transform">
                ...
                >
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center gap-2">
                            ...
                            <h2 class="text-xs font-black uppercase text-gray-800 dark:text-gray-100 tracking-tight">
                                Tài liệu & Bằng chứng
                            </h2>
                        </div>
                        <span class="text-[9px] text-gray-400 uppercase font-bold tracking-widest">
                            Tải lên: 2 giờ trước
                        </span>
                    </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 relative">
                        ...
                        >
                            <i
                                class="fa-solid fa-file-pdf text-red-500 text-2xl mb-2 opacity-60 group-hover:opacity-100 transition-opacity"
                            ></i>
                            <span class="text-[10px] text-gray-500 font-black uppercase tracking-tighter">
                                BẰNG CHỨNG.pdf
                            </span>
                        </div>
                    ...
                    >
                        <div class="flex items-start gap-3">
                            ...
                            <p
                                class="text-[11px] md:text-xs text-gray-600 dark:text-gray-300 leading-relaxed font-medium"
                            >
                ...
                >
                    <div class="flex items-center justify-between mb-8">
                        <div class="flex items-center gap-2">
                            ...
                            <h2 class="text-sm font-black uppercase text-gray-800 dark:text-gray-100 tracking-tight">
                                Cảnh báo liên quan mật thiết
                            </h2>
                        </div>
                        <span
                            class="text-xs text-cs_red font-black uppercase bg-red-100/50 dark:bg-red-900/20 px-3 py-1 rounded-lg"
                        >
                            CÙNG HỆ SINH THÁI
                        </span>
                    </div>
                            ...
                            <div class="flex-1">
                                ...
                                >
                                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="text-xs font-black text-gray-800 dark:text-gray-100 uppercase tracking-tight"
                                            >
                                                Người dùng ẩn danh
                                            </span>
                                        </div>
                ...
                >
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                <div
                                    class="absolute top-0 right-0 w-16 h-16 bg-cs_red/5 rounded-full -mr-8 -mt-8"
                                ></div>
                                <span class="block text-[10px] font-black text-cs_red/60 uppercase tracking-[2px] mb-1">
                                    Trạng thái xác minh
                                </span>
                                <h3 class="text-xl font-black text-cs_red uppercase tracking-tighter">
                                    CẢNH BÁO LỪA ĐẢO
                                </h3>
                                <div class="mt-2 flex items-center justify-center gap-1">
                                    <div class="w-1.5 h-1.5 rounded-full bg-cs_red animate-pulse"></div>
                                    <span class="text-[9px] font-bold text-cs_red/80 uppercase">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            >
                                <span class="text-xs font-bold text-gray-400 block mb-1 uppercase tracking-tighter">
                                    Tra cứu
                                </span>
                                <span
                                    class="text-lg font-black text-gray-800 dark:text-gray-100 group-hover:text-cs_blue transition-colors"
                                >
                                    162+
                                </span>
                            </div>
                            ...
                            >
                                <span class="text-xs font-bold opacity-60 block mb-1 uppercase tracking-tighter">
                                    Báo cáo
                                </span>
                                <span
                                    class="text-lg font-black group-hover:scale-110 transition-transform inline-block font-mono"
                                >
                                    03
                                </span>
                            </div>
        ...
        <div class="mt-10 pt-16 border-t border-gray-100 dark:border-gray-800/60">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-6 gap-6">
                <div class="px-2">
                    <span class="text-xs font-black text-cs_red uppercase tracking-[5px] mb-3 block animate-pulse">
                        Hot Blacklist
                    </span>
                    <h2
                ...
                >
                    ...
                    >
                        <div class="w-full sm:w-5/12 flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-gray-900 dark:text-gray-100 text-xs md:text-sm font-bold">
                                    Nguyễn Văn A -
