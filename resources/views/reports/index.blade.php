...
@section("content")
    <main class="pb-24">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            @if (session("success"))
                <div
                    class="mb-6 rounded-md border border-green-200 bg-green-50 px-4 py-3 text-sm font-semibold text-green-700"
                >
            ...
            @if (session("error"))
                <div
                    class="mb-6 rounded-md border border-red-200 bg-red-50 px-4 py-3 text-sm font-semibold text-red-700"
                >
...
{{ old("description") }}</textarea
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    >
                                        Tôi xin cam đoan nội dung tố cáo là sự thật và chịu trách nhiệm về thông tin
                                        này.
                                    </label>
                                </div>
                            </div>
            ...
            function initImagePreview(inputId, previewId) {
                ...
                input.addEventListener('change', function () {
                    Array.from(this.files).forEach((file) => {
                        const isDuplicate = fileList.find(
