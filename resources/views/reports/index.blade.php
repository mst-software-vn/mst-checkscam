          ...
          >
            ...
            <ul class="space-y-4">
              <li class="flex gap-3">
                ...
                <p class="text-[12px] leading-relaxed font-semibold text-gray-500 md:text-sm dark:text-gray-400">
            ...
            <div class="relative space-y-5">
              ...
              <div class="relative pl-6">
                ...
                <p class="text-[12px] font-semibold text-gray-500 italic md:text-sm dark:text-gray-400">
                  Xác minh:
                  <span class="font-normal not-italic">Đội ngũ Admin kiểm tra tính xác thực (30p - 12h).</span>
                </p>
              </div>
              <div class="relative pl-6">
                <div
            ...
            >
              ...
              <div class="grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-6">
                ...
                <div class="space-y-2 md:col-span-2">
                  ...
                  >
                    ...
                    <option value="Lừa đảo mua bán" {{ old('category') == 'Lừa đảo mua bán' ? 'selected' : '' }}>
                      Lừa đảo mua bán
                    </option>
                    <option
                    ...
                    <option value="Lừa đảo CTV" {{ old('category') == 'Lừa đảo CTV' ? 'selected' : '' }}>
                      Lừa đảo CTV
                    </option>
                    <option
                    ...
                    <option value="Đánh cắp tài khoản" {{ old('category') == 'Đánh cắp tài khoản' ? 'selected' : '' }}>
                      Đánh cắp tài khoản
                    </option>
                    <option value="Cá cược, lô đề" {{ old('category') == 'Cá cược, lô đề' ? 'selected' : '' }}>
                      Cá cược, lô đề
                    </option>
                    <option value="Đầu tư đa cấp ảo" {{ old('category') == 'Đầu tư đa cấp ảo' ? 'selected' : '' }}>
                      Đầu tư đa cấp ảo
                    </option>
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <div
                    id="bank-preview"
                    class="mb-4 grid w-full grid-cols-3 gap-3 empty:hidden sm:grid-cols-4 md:grid-cols-5"
                  ></div>

                  {{-- Placeholder text -- ẩn khi đã có ảnh --}}
                  <div id="bank-placeholder" class="flex flex-col items-center justify-center text-center">
                    <i
                  ...
                  <div id="bank-add-more" class="mt-3 hidden flex-col items-center text-center">
                    ...
                    <span class="text-cs_red text-[9px] font-semibold tracking-widest uppercase md:text-[10px]">
                      Thêm ảnh
                    </span>
                  </div>
    ...
    {{ old('description') }}</textarea
              ...
              >
                <div class="flex-1 space-y-2">
                  <label class="text-[10px] font-semibold tracking-widest text-gray-400 uppercase dark:text-gray-500">
                    Tên thật
                    <span class="text-cs_red">*</span>
                  </label>
                  <input
    ...
    {{ old('description') }}</textarea
      ...
      <article class="mx-auto mt-16 max-w-4xl space-y-10 md:mt-24 md:space-y-14">
        <div class="text-center">
          <h2 class="text-md mb-4 font-semibold tracking-[0.2em] text-gray-800 uppercase md:text-lg dark:text-gray-100">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-12">
          ...
          >
            ...
            <p class="text-[13px] leading-relaxed font-semibold text-gray-500 italic dark:text-gray-400">
              Dữ liệu người tố cáo chỉ được dùng để xác minh nội bộ và hoàn toàn không công khai để bảo vệ danh tính cá
              nhân.
            </p>
          </section>
          <section
    ...
    <div class="relative w-full max-w-lg rounded-md bg-white shadow-2xl dark:bg-slate-900">
      ...
      <div class="px-8 py-7 text-center">
        ...
        <p class="mb-5 text-[13px] leading-relaxed text-gray-500 dark:text-gray-400">
          Để xác nhận đơn đã duyệt, hãy tra cứu lại số tài khoản hoặc website bạn vừa tố cáo trên trang chủ. Nếu chưa
          xuất hiện, bạn có thể bổ sung thêm bằng chứng và gửi lại.
        </p>

        {{-- Shield icons --}}
        <div class="text-cs_blue mb-5 flex items-center justify-center gap-2">
        ...
        {{-- Highlight notice --}}
        <p class="mb-1 text-[13px] font-bold tracking-wider text-gray-700 uppercase dark:text-gray-200">
          Hãy cảnh báo người thân & bạn bè
        </p>
        <p class="mb-6 text-[13px] font-bold tracking-wider text-gray-700 uppercase dark:text-gray-200">
          <a href="{{ route('home') }}" class="text-cs_red hover:underline">[ TRA CỨU NGAY TRÊN CHECKSCAM ]</a>
          <br />
      ...
      function initImagePreview(inputId, previewId) {
        ...
        input.addEventListener('change', function () {
          Array.from(this.files).forEach((file) => {
            const isDuplicate = fileList.find((f) => f.file.name === file.name && f.file.size === file.size);
