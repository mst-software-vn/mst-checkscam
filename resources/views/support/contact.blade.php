        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header class="mb-16 text-center">
                <h1 class="text-3xl md:text-5xl font-black text-gray-800 dark:text-gray-100 uppercase tracking-tighter mb-4">
                    Liên hệ <span class="text-cs_blue">Admin</span>
                </h1>
                <p
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-xs font-bold uppercase mb-4 tracking-tighter">Hỗ trợ
                            nhanh 24/7</p>
                        <a href="https://www.facebook.com/mstsoftware.vn" target="_blank"
                            class="block w-full py-3 bg-cs_blue text-white text-center rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 transition-all">Gửi
                            tin nhắn</a>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-xs font-bold uppercase mb-4 tracking-tighter">
                            mstsoftware.vn@gmail.com</p>
                        <a href="mailto:mstsoftware.vn@gmail.com"
                            class="block w-full py-3 border-2 border-gray-100 dark:border-gray-800 text-gray-400 hover:text-cs_blue hover:border-cs_blue text-center rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">Gửi
                            Email</a>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2">
                    <div
                        ...
                        <div class="mb-8">
                            <h2 class="text-2xl font-black text-gray-800 dark:text-white uppercase tracking-tight">Gửi yêu
                                cầu hỗ trợ</h2>
                            <p class="text-gray-500 dark:text-gray-500 text-xs font-bold uppercase tracking-widest mt-1">Vui
                                lòng điền thông tin để chúng tôi liên hệ lại</p>
                        </div>

                        <form class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4">Họ và
                                        tên</label>
                                    <input type="text"
                                ...
                                <div class="space-y-2">
                                    <label
                                        class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4">Telegram
                                        / Zalo</label>
                                    <input type="text"
                                        class="w-full px-5 py-4 bg-gray-50/50 dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-2xl text-sm font-bold text-gray-700 dark:text-gray-300 focus:border-cs_blue outline-none transition-all"
                            ...
                            <div class="space-y-2">
                                <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4">Vấn đề
                                    cần hỗ trợ</label>
                                <select
                            ...
                            <div class="space-y-2">
                                <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4">Nội dung
                                    chi tiết</label>
                                <textarea rows="4"
