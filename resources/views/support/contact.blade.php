        ...
        <div class="lg:col-span-2">
          ...
          >
            <div class="mb-8">
              ...
              <p class="mt-1 text-xs font-bold tracking-widest text-gray-500 uppercase dark:text-gray-500">
            ...
            <form class="space-y-6">
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="space-y-2">
                  <label class="ml-4 text-[10px] font-black tracking-widest text-gray-400 uppercase">Họ và tên</label>
                  <input
                    type="text"
