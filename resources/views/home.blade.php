        ...
        <div class="w-full space-y-8 {{ request()->query('q') ? 'lg:w-full lg:max-w-4xl mx-auto' : 'lg:w-9/12' }}">
            ...
            <section>
                ...
                <div
                    ...
                    <a href="/{{ $item->slug ?? 'chi-tiet-scam' }}"
                        ...
                        <div class="w-full border-gray-100 sm:w-3/12 sm:border-l sm:px-6 dark:border-gray-800">
                            <div class="flex items-center gap-6">
                                ...
                                <div class="flex flex-col">
                                    <span
                                        class="text-[9px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">Bình
                                        luận</span>
                        ...
                        <div class="w-full text-right sm:w-2/12">
                            <span
                                class="text-cs_blue hover:bg-cs_blue inline-block rounded bg-blue-50 px-3 py-1 text-[10px] font-black uppercase transition-all hover:text-white dark:bg-blue-900/20">Chi
                                tiết</span>
                        </div>
                    </a>
                    @endforeach
                ...
                <section>
                    <div class="border-cs_blue mb-4 mt-12 flex items-center gap-2 border-l-4 pl-3">
                        ...
                        <a href="/{{ $item->slug }}"
                            ...
                            <div class="w-full border-gray-100 sm:w-3/12 sm:border-l sm:px-6 dark:border-gray-800">
                                <div class="flex flex-col">
                                    ...
                                    <span
                                        class="text-cs_red text-xs font-bold tracking-wider">{{ $item->target_id }}</span>
                                </div>
                            </div>
                        ...
                        <a href="{{ route('search.index', ['q' => $item->target_id]) }}"
                            ...
                            <div class="w-full border-gray-100 sm:w-3/12 sm:border-l sm:px-6 dark:border-gray-800">
                                <div class="flex flex-col">
                                    ...
                                    <span
                                        class="{{ $item->is_scam ? 'text-cs_red' : 'text-gray-700' }} text-xs font-bold tracking-wider">{{ $item->target_id }}</span>
                                </div>
                            </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-1.5">
                            <span class="relative flex h-2 w-2">
                                <span
                                    class="bg-cs_blue absolute inline-flex h-full w-full animate-ping rounded-full opacity-75"></span>
            ...
            <div class="grid grid-cols-1 items-start gap-3">
                <details
                    ...
                    <summary class="flex cursor-pointer list-none items-center justify-between p-4 md:p-5">
                        ...
                        <i
                            class="fa-solid fa-chevron-down text-[10px] text-gray-300 transition-transform group-open:rotate-180 md:text-xs"></i>
                    </summary>
                    <div
