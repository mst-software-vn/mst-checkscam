...
@section("content")
    ...
    <main class="mx-auto w-full max-w-7xl grow px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 flex flex-col gap-4 lg:flex-row">
            <!-- Khu Vực Trái -->
            <div class="{{ request()->query("q") ? "mx-auto lg:w-full lg:max-w-4xl" : "lg:w-9/12" }} w-full space-y-8">
                @if (request()->query("q"))
                    <!-- KẾT QUẢ TÌM KIẾM -->
                    <section>
                                    ...
                                    >
                                        ...
                                        <div class="flex w-full items-center gap-3 sm:w-4/12">
                                            ...
                                            <div>
                                                ...
                                                <div
                                                    class="mt-0.5 text-[10px] font-bold text-gray-400 dark:text-gray-500"
                                                >
                                        ...
                                        <!-- Thông tin định danh -->
                                        <div
                                            class="w-full border-gray-100 sm:w-3/12 sm:border-l sm:px-6 dark:border-gray-800"
                                        >
                            ...
                            @if (isset($topWeeklyReports) && $topWeeklyReports->count() > 0)
                                @foreach ($topWeeklyReports as $index => $item)
                                    ...
                                    >
                                        ...
                                        <!-- Chỉ số tín nhiệm (Stats) -->
                                        <div
                                            class="w-full border-gray-100 sm:w-4/12 sm:border-l sm:px-4 dark:border-gray-800"
                                        >
                                            <div
                                                class="flex items-center justify-between sm:justify-start sm:gap-4 md:gap-6"
                                            >
                                                <div class="flex flex-col">
                                                    <span
                                                        class="text-[9px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500"
            ...
            @if (! request()->query("q"))
                ...
                <aside class="w-full space-y-3 lg:w-3/12">
                    ...
                    >
                        <div
                            class="border-b border-gray-100 bg-gray-50/50 p-4 dark:border-gray-800 dark:bg-slate-800/20"
                        >
                                ...
                                @foreach ($recentSearches as $search)
                                    ...
                                    >
                                        <div class="flex min-w-0 items-center gap-3">
                                            ...
                                            <div class="min-w-0">
                                                <p
                                                    class="truncate text-[13px] font-bold text-gray-700 dark:text-gray-300"
                                                >
                                                    {{ $search }}
                                                </p>
                                            </div>
                        ...
                        <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:col-span-7">
                                ...
                                >
                                    ...
                                    <p class="mb-6 text-xs leading-relaxed text-slate-500 dark:text-slate-400">
                                        Định danh User ID và Username để loại bỏ các trường hợp mạo danh Admin hoặc
                                        trung gian uy tín.
                                    </p>
                                    <div
                                        class="flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800"
                                ...
                                >
                                    ...
                                    <p class="mb-6 text-xs leading-relaxed text-slate-500 dark:text-slate-400">
                                        Mỗi báo cáo của cộng đồng là một viên gạch xây dựng nên lá chắn vững chắc cho
                                        MMO Việt.
                                    </p>
                                    <div
                                        class="flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800"
                    ...
                    <div class="grid grid-cols-1 items-start gap-3">
                        ...
                        >
                            ...
                            <div
                                class="border-t border-gray-50 px-5 pt-3 pb-5 pl-12 text-[11px] leading-relaxed text-gray-500 md:pl-[68px] md:text-[13px] dark:border-gray-800 dark:text-gray-400"
                            >
                                Hệ thống kiểm tra thủ công để tránh tình trạng tố cáo ảo. Nếu sau 24h chưa duyệt, hãy
                                kiểm tra lại tính minh bạch của bằng chứng bạn gửi.
                            </div>
                        </details>
                        ...
                        >
                            ...
                            <div
                                class="border-t border-gray-50 px-5 pt-3 pb-5 pl-12 text-[11px] leading-relaxed text-gray-500 md:pl-[68px] md:text-[13px] dark:border-gray-800 dark:text-gray-400"
                            >
                                Trung gian uy tín đóng quỹ (tiền ký quỹ) cho Admin. Nếu họ lừa đảo, Admin dùng tiền đó
                                đền bù cho bạn 100%.
                            </div>
                        </details>
                        ...
                        >
                            ...
                            <div
                                class="border-t border-gray-50 px-5 pt-3 pb-5 pl-12 text-[11px] leading-relaxed text-gray-500 md:pl-[68px] md:text-[13px] dark:border-gray-800 dark:text-gray-400"
                            >
                                Chỉ gỡ khi người tố cáo xác nhận đã giải quyết xong. Chúng tôi KHÔNG gỡ vì hối lộ hay áp
                                lực từ kẻ lừa đảo.
                            </div>
                        </details>
                    </div>
